                        ...
                        <div class="charity-team charity-simple-team ">
                            <ul class="row">
                                @foreach($officers as $officer)
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="{{$officer->avatar === null ? asset
                                                    ('images/members/default.jpg')  :
                                                asset('images/members/'.$officer->avatar)}}" alt="DRR Washima
                                    Cleopatra"></a>
                                            <figcaption>
                                                ...
                                                <div class="charity-simple-team-text">
                                                    <h2><a href="#"> {{$officer->name}}</a></h2>
                                                    <span>ADRR, Zone {{$officer->office_title.' '.
                                                            $officer->state_name}} State</span>
