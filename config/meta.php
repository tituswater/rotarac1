...
return [
    ...
    */
    ...
    |
    */
	'title'	=> 'Rotaract District 9125 Nigeria Official Website',
    ...
    |
    */
    'description' => 'Rotaract District 9125 Nigeria cosnstist of 23 State  from the North, SouthWest region of Nigeria Excluding Lagos and Ogn State which brings together people of ages 18-31 to exchange ideas with leaders in
    the community, develop leadership and professional skills, and have fun through service. In communities
    worldwide, Rotary and Rotaract members work side by side to take action through service',
    ...
    |
    */
	'image' => '{{ asset("images/rotaract_district9125.png") }}',
    ...
    */
    ...
    |
    */
	'geo_region' => 'Ekiti', //e.g: Lagos
	'geo_position' => '7.7190, 5.3110', //e.g(lng,lat): 4.870467,6.993388
    ...
    */
    ...
    |
    */
	'keywords' => 'rotaract, District 9125, Nigeria, Humanitarian Service, purpose of rotaract, rac,rotary',
